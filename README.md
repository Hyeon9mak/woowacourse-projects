...
- [babble 팀 블로그](https://babble-dev.tistory.com/)

### 팀 프로젝트 발표 영상
- [프로젝트 1차 데모 영상](https://youtu.be/ifTJ5Cee72s)
...
- [private IP 만으론 인터넷 연결이 불가능한가?](https://hyeon9mak.github.io/private-ip-can-not-connect-to-internet/)
- [CloudFront를 통해 S3 액세스 하기](https://hyeon9mak.github.io/access-s3-through-cloudfront/)
- [소켓 기본 개념](https://hyeon9mak.github.io/socket-overview/)
- [spring web-socket 기본 구성](https://hyeon9mak.github.io/spring-web-socket/)
- [web-socket 연결 끊김 감지하기](https://hyeon9mak.github.io/web-socket-disconnection-detection/)
- [로컬 DB 도커로 마이그레이션 하기](https://hyeon9mak.github.io/migrate-local-database-to-docker/)
- [NGINX 웹 소켓 프록시 설정](https://hyeon9mak.github.io/nginx-web-socket-proxy-configuration/)
- [Github actions self-hosted runner를 EC2에서 동작시키기](https://hyeon9mak.github.io/github-actions-self-hosted-runner-on-ec2/)
- [Github Personal Access Token 토큰 발급, 키체인 설정](https://hyeon9mak.github.io/github-personal-access-token/)
- [에러 메세지를 상세하게 던져야 하는 이유](https://hyeon9mak.github.io/why-should-throw-detail-error-message/)
- [macOS Big Sur JDK 설치 및 버전 변경](https://hyeon9mak.github.io/macos-big-sur-install-jdk-and-change-version/)
- [React S3, CloudFront에 배포하기](https://hyeon9mak.github.io/react-spa-s3-cloudfront/)
- [CloudFront 도메인 이름 변경하기 (신규등록)](https://hyeon9mak.github.io/change-cloudfront-domain-name/)
- [Invalidations를 이용한 CloudFront 캐싱 컨트롤](https://hyeon9mak.github.io/cloudfront-caching-control-with-invalidations/)
- [도커 컨테이너 IP 주소 트러블 슈팅](https://hyeon9mak.github.io/docker-container-ip-address/)
- [도커, 스프링부트 타임 존 설정](https://hyeon9mak.github.io/docker-spring-boot-time-zone/)
- [Github-actions 작업간 독립성](https://hyeon9mak.github.io/independent-between-github-actions-jobs/)
- [소나큐브 설치하기](https://hyeon9mak.github.io/install-sonarqube/)
- [팀 프로젝트가 나에게 남긴 것](https://hyeon9mak.github.io/%ED%8C%80-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8%EA%B0%80-%EB%82%98%EC%97%90%EA%B2%8C-%EB%82%A8%EA%B8%B4-%EA%B2%83/)
- [@NotNull 어노테이션 예외처리 핸들링](https://hyeon9mak.github.io/not-null-annotation-exception-handling/)
